  ...
  <div class="sidebar">
    ...
    <span class="logo_name">Portal del Trabajador</span> 
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="SAP.php?encrypt=<?php echo $encriptado?>">
...
<!--==============================================================================================================================================================================-->
                        <td class="text-center-results" title-results="Visualizar:"><a target="_blank" href="<?php echo $rowSql["link"]; ?>"><i class="demo-icon demo-icon-results icon-search"></i></a></td>
<!--==============================================================================================================================================================================-->                        
                        <td class="text-center-results" title-results="Descargar:"><a target="_blank" href="<?php echo $rowSql["link"]; ?>" download="Boleta"><i class="demo-icon demo-icon-results icon-download-alt"></i></a></td>
<!--==============================================================================================================================================================================-->
                        <td class="text-center-results" title-results="Enviar:"><a  target="_blank" href="<?php echo $rowSql["email"]; ?>" src="img/correo.png" ><i class="demo-icon demo-icon-results icon-mail-alt"></i><a></td>
<!--==============================================================================================================================================================================-->      
